...
import pages.filtrele.CepTelefonuFiltrelemeMarka;
...
public class CepTelefonuFiltrelemePageTest extends BaseTest {
    ...
    private CepTelefonuFiltrelemeMarka cepTelefonuFiltrelemeMarka;
    @Override
    public void intializePages() {
        ...
        cepTelefonuFiltrelemeMarka=new CepTelefonuFiltrelemeMarka(driver);
    }
    @Test
    public void cepTelefonuFiltrelemeTest() throws InterruptedException {
        ...
        Thread.sleep( 2000 );
        cepTelefonuFiltrelemePage.selectFilterOption( CepTelefonuFiltrelemePage.FilterOption.MARKA );
        cepTelefonuFiltrelemeMarka.filterByOption( CepTelefonuFiltrelemeMarka.FilterOption.APPLE );
        n11Pages.clickFiltreleSonucGoster();
        Thread.sleep( 2000 );
    }
