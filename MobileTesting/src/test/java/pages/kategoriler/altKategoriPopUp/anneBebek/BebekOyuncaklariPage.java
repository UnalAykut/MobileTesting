...
public class BebekOyuncaklariPage extends BasePage implements PageActions<BebekOyuncaklariPage.Kategori> {
    ...
    public void clickOnCategory(BebekOyuncaklariPage.Kategori kategori) {
