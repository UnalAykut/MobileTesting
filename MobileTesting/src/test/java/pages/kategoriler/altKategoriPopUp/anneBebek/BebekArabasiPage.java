...
public class BebekArabasiPage extends BasePage implements PageActions<BebekArabasiPage.Kategori> {
    ...
    public void clickOnCategory(BebekArabasiPage.Kategori kategori) {
